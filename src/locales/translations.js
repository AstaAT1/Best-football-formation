export const translations = {
    en: {
        ...
        modeSelectDraft: "Draft Arena",
        modeSelectDraftSub: "Build your dream squad",
        modeSelectClubPath: "Guess by Clubs",
        modeSelectClubPathSub: "Identify players by career",
        startClubPath: "START GUESSING ⚡",
        clubPathTitle: "Guess the Player by Clubs",
        clubPathDesc: "10 questions per round",
        clubPathRule1: "You'll see a sequence of club logos and transfer years",
        clubPathRule2: "Type the player's name who had this career path",
        clubPathRule3: "20 seconds per question — be quick!",
        guessByClubs: "GUESS BY CLUBS",
        clubPathQuestion: "Question",
        whoIsThisPlayer: "Who is this player?",
        clubPathHint: "Identify the player from their club career path",
        ...
        backToMenu: "BACK",
        clubPathResultsSub: "Guess the Player by Clubs — Results",
        clubPathGradeExcellent: "Excellent!",
        clubPathGradeGood: "Good job!",
        clubPathGradeKeepTrying: "Keep trying!",
    },
    fr: {
        // Welcome Screen
        appTitle: "⚽ Draft Arena",
        ...
        modeSelectDraft: "Draft Arena",
        modeSelectDraftSub: "Construisez votre équipe de rêve",
        modeSelectClubPath: "Devinez par clubs",
        modeSelectClubPathSub: "Identifiez les joueurs par carrière",
        startClubPath: "COMMENCER ⚡",
        clubPathTitle: "Devinez le joueur par ses clubs",
        clubPathDesc: "10 questions par manche",
        clubPathRule1: "Vous verrez une séquence de logos de clubs et d'années de transfert",
        clubPathRule2: "Tapez le nom du joueur qui a eu ce parcours de carrière",
        clubPathRule3: "20 secondes par question — soyez rapide !",
        guessByClubs: "DEVINEZ PAR CLUBS",
        clubPathQuestion: "Question",
        whoIsThisPlayer: "Qui est ce joueur ?",
        clubPathHint: "Identifiez le joueur à partir de son parcours en clubs",
        enterPlayerName: "Entrez le nom du joueur...",
        submitAnswer: "VALIDER",
        correct: "✅ CORRECT !",
        incorrect: "❌ INCORRECT",
        thePlayerWas: "Le joueur était",
        yourAnswer: "Votre réponse",
        backToMenu: "RETOUR",
        clubPathResultsSub: "Devinez le joueur par ses clubs — Résultats",
        clubPathGradeExcellent: "Excellent !",
        clubPathGradeGood: "Bien joué !",
        clubPathGradeKeepTrying: "Continuez à essayer !",
    },
    ar: {
        // Welcome Screen
        ...
        // Club Path Mode
        gameModeLabel: "وضع اللعب",
        modeSelectDraft: "ساحة الدرافت",
        modeSelectDraftSub: "ابنِ فريق أحلامك",
        modeSelectClubPath: "خمّن بالأندية",
        modeSelectClubPathSub: "حدد اللاعبين من مسيرتهم",
        startClubPath: "ابدأ التخمين ⚡",
        clubPathTitle: "خمّن اللاعب من أنديته",
        clubPathDesc: "10 أسئلة في كل جولة",
        clubPathRule1: "ستظهر لك سلسلة من شعارات الأندية وسنوات الانتقال",
        clubPathRule2: "اكتب اسم اللاعب الذي كان له هذا المسار",
        clubPathRule3: "20 ثانية لكل سؤال — كن سريعاً!",
        guessByClubs: "خمّن بالأندية",
        clubPathQuestion: "سؤال",
        whoIsThisPlayer: "من هو هذا اللاعب؟",
        clubPathHint: "حدد اللاعب من مسيرته في الأندية",
        enterPlayerName: "أدخل اسم اللاعب...",
        submitAnswer: "أرسل الإجابة",
        correct: "✅ صحيح!",
        incorrect: "❌ خطأ",
        thePlayerWas: "اللاعب كان",
        yourAnswer: "إجابتك",
        backToMenu: "رجوع",
        clubPathResultsSub: "خمّن اللاعب من أنديته — النتائج",
        clubPathGradeExcellent: "ممتاز!",
        clubPathGradeGood: "أحسنت!",
        clubPathGradeKeepTrying: "واصل المحاولة!",
    }
};
